...
public class QP {
	...
	public QP(int maxqpsize) {
		opt_ce = new double[maxqpsize];
		opt_ce0 = new double[1];
		opt_g = new double[(maxqpsize) * (maxqpsize)];
		opt_g0 = new double[maxqpsize];
		opt_xinit = new double[maxqpsize];
		opt_low = new double[maxqpsize];
		opt_up = new double[maxqpsize];
	}
