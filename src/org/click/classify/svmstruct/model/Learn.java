...
public class Learn {
	...
	/**
	 * The following solves a freely defined and given set of <br>
	 * inequalities. The optimization problem is of the following form: OP1 <br>
	 * &nbsp;&nbsp; min 0.5 w*w + C sum_i C_i \xi_i <br>
	 * &nbsp;&nbsp; s.t. x_i * w > rhs_i - \xi_i <br>
	 * This corresponds to the -z o option. <br>
	 * <br>
	 * totdoc, totwords may be changed during optimization process <br>
	 * 
	 * @param docs
	 * @param rhs
	 * @param totdoc
	 ...
	 * @param alpha
	 */
	public void svm_learn_optimization(DOC[] docs, double[] rhs, int totwords, LEARN_PARM learn_parm, KERNEL_PARM kernel_parm, MODEL model, double[] alpha) {

		int i, iterations, svsetnum = 0, maxslackid;
		int[] label, index, index2dnum;
		double[] lin, a, c, weights, slack, alphaslack, aicache;
		double r_delta_avg;
		...
		//a should be the lagrange multiplier factors of the inequality in OP1
		//the above is maybe wrong, the largrange is the aim to optimize 
		//write down and check what is a, lin, and c
		a = new double[totdoc];
		...
		model.init(totdoc, totwords, kernel_parm);
	...
	public int optimize_to_convergence(DOC[] docs, int[] label, int totdoc, int totwords, LEARN_PARM learn_parm, KERNEL_PARM kernel_parm, MODEL model, double[] a, double[] lin, double[] c, int heldout, int retrain, CheckStruct struct) {
		...
		qp = new QP(learn_parm.svm_maxqpsize);
	...
	public int optimize_to_convergence_sharedslack(DOC[] docs, int[] label, int totdoc, int totwords, LEARN_PARM learn_parm, KERNEL_PARM kernel_parm, MODEL model, double[] a, double[] lin, double[] c, CheckStruct struct) {
		...
		QP qp = new QP(learn_parm.svm_maxqpsize); // buffer for one quadratic program
	...
	// compute the value of shared slacks and the joint alphas 
	public void compute_shared_slacks(DOC[] docs, int[] label, double[] a, double[] lin, double[] c, int[] index2dnum, LEARN_PARM learn_parm, double[] slack, double[] alphaslack) {
		int jj, i;
		double dist, target;
